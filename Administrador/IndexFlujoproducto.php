<?php
include_once 'crudFlujoproducto.php';
session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
              <a href="indexFlujoproducto.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Mantenimiento Relaciones Comerciales</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="indexMenu.php">Home</a></li>
          <li class="breadcrumb-item">Tablas</li>
          <li class="breadcrumb-item active">Flujo Producto</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <!-- Columna 1---> 
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tabla Flujo Producto</h5>
              ...
              <thead>
                  ...
                  <?php
                  $res=$MySQLiconn->query("SELECT * FROM flujoproducto");
                  while($row=$res->fetch_array()){
                      ?>
                      <tr>
                          <td><?php echo $row['idflujo']; ?></td>
                          <td><?php echo $row['idproducto']; ?></td>
                          <td><?php echo $row['idpais']; ?></td>
                          <td><?php echo $row['tipo']; ?></td>
                          <td><a href="?edit=<?php echo $row['idflujo']; ?>" onclick="return confirm('Confirmar edicion')">Editar</a></td>
                          <td><a href="?del=<?php echo $row['idflujo']; ?>" onclick="return confirm('Confirmar eliminacion')">Eliminar</a></td>
                      </tr>
                      <?php
                  }
                  ?>
  ...
  <!--Columna Numero 2-->
        ...
        <div class="col-lg-3">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Registrar Relacion Comercial</h5>

              <form method="post">
                <table class="table table-sm">
                    <tr>
                        <td>
                            <input width="100%" type="text" name="idproducto" placeholder="Producto" value="<?php if(isset($_GET['edit'])){ echo $getRow['idproducto'];}?>">           
                        </td>
                    </tr>
                    <tr>
                        <td>
