    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            <li>
              <a href="indexUsuario.php" class="active">
              ...
              <thead>
                  ...
                  while($row=$res->fetch_array()){
                      ...
                      <tr>
                          ...
                          <td><a href="?edit=<?php echo $row['idusuario']; ?>" onclick="return confirm('Confirmar edicion')">Editar</a></td>
                          <td><a href="?del=<?php echo $row['idusuario']; ?>" onclick="return confirm('Confirmar eliminacion')">Eliminar</a></td>
                      </tr>
                      <?php
                  }
                  ?>
            ...
            <div class="card-body">
              ...
              <form method="post">
                <table class="table table-sm">
                    <tr>
                        <td>
                            <input width="100%" type="text" name="nombre" placeholder="Nombre" value="<?php if(isset($_GET['edit'])){ echo $getRow['nombre'];}?>">           
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="text" name="apellido" placeholder="Apellido" value="<?php if(isset($_GET['edit'])){ echo $getRow['apellido'];}?>">              
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="text" name="contrasena" placeholder="Contraseña" value="<?php if(isset($_GET['edit'])){ echo $getRow['contrasena'];}?>">              
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="text" name="nivel" placeholder="Nivel" value="<?php if(isset($_GET['edit'])){ echo $getRow['nivel'];}?>">              
                        </td>
                    </tr>
                    <tr>
                        <td>
