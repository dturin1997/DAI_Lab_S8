    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
              <a href="indexPais.php" class="active">
    ...
    <!-- Columna 1---> 
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tabla Paises</h5>
              ...
              <thead>
                  ...
                  while($row=$res->fetch_array()){
                      ...
                      <tr>
                          ...
                          <td><a href="?edit=<?php echo $row['idpais']; ?>" onclick="return confirm('Confirmar edicion')">Editar</a></td>
                          <td><a href="?del=<?php echo $row['idpais']; ?>" onclick="return confirm('Confirmar eliminacion')">Eliminar</a></td>
                      </tr>
                      <?php
                  }
                  ?>
